      ...
      <CRow>
        <CCol xs>
          <CCard className="mb-4">
            <CCardHeader>OutPatient Session</CCardHeader>
            <CCardBody>
              <br />
              ...
              <CTable align="middle" className="mb-0 border" hover responsive>
                <CTableHead color="light">
                  <CTableRow>
                    ...
                    <CTableHeaderCell className="text-center">Doctor Name</CTableHeaderCell>
                    ...
                    <CTableRow v-for="item in tableItems" key={index}>
                      ...
                      <CTableDataCell>
                        <div className="text-center">
                          <small className="text-medium-emphasis">{item.schedule.period}</small>
                        </div>
                      </CTableDataCell>
                      <CTableDataCell className="text-center">
